                ...
                <form method="" action="" class="border border-2 rounded-4 p-4 pt-2" style="margin: 0px 30px" onsubmit="return validateForm()">
                    ...
                    <div class="form-group w-100">
                        <div class="form-hover">
                            <input type="text" id="title" name="title" placeholder="Tiêu đề" readonly value="Tieu de 1" class="form-control form-control-lg"/>
                    ...
                    <div class="form-outline mt-4 w-100">
                        <div class="validate form-outline col">
                            ...
                            <div class="form-hover">
                                <input type="file" name="newsPic" id="newsPic" accept="image/*" readonly value=""
                    ...
                    <div class="form-outline form-group mt-4 w-100">
                        <div class="form-hover">
                            <textarea type="text" id="contentMain" name="contentMain" placeholder="Nội dung chính"
                                      class="form-control form-control-lg" rows="8" cols="10" style="max-height: 150px;" readonly>main content</textarea>
                    ...
                    <div class="form-outline form-group mt-4 w-100">
                        <div class="form-hover">
                            <textarea type="text" id="content1" name="content1" placeholder="Nội dung 1"
                                      class="form-control form-control-lg" rows="8" cols="10" style="max-height: 100px;" readonly>content 1</textarea>
                    ...
                    <div class="form-outline form-group w-100 mt-4">
                        <div class="form-hover">
                            <textarea type="text" id="content2" name="content2" placeholder="Nội dung 2"
                                      class="form-control form-control-lg" rows="8" cols="10" style="max-height: 100px;" readonly>content 2</textarea>
                    ...
                    <div class="form-outline form-group mt-4 w-100">
                        <div class="form-hover">
                            <textarea type="text" id="content3" name="content3" placeholder="Nội dung 3"
                                      class="form-control form-control-lg" rows="8" cols="10" style="max-height: 100px;" readonly>content 3</textarea>
                    ...
                    <div class="form-outline mt-4">
                        ...
                        <div class="form-hover">
                            <input type="date" id="dayWriteNews" name="dayWriteNews" class="form-control form-control-lg" readonly value="2024-02-12"/>
                        </div>
                    ...
                    <div class="form-outline mb-3 mt-4">
                        <input type="submit" name="btn-DeleteNews" class="btn btn-success w-100" style="font-size: 20px" value="Delete News"/>
                    </div>  
                </form>
            </div>
        </div>
