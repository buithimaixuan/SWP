                                            ...
                                            <p class="text-muted mb-0" style="display: flex;"><span class="fw-bold me-4 mt-2">Trạng thái: </span>
                                                <span>
                                                    <select class="form-select">
                                                        <option value="value">Chờ xác nhận</option>
                                                        <option value="value">Đã xác nhận</option>
                                                        <option value="value">Đang giao</option>
                                                        <option value="value">Đã giao</option>
                                                        <option value="value">Đã hủy</option>
                                                    </select>
                                                </span>
                                            </p>
                                            <p class="text-muted mb-0 mt-2"><span class="fw-bold me-4">Phương thức thanh toán: </span>COD</p>
                                        </div>
                                        
                                         <div class="d-flex justify-content-between mt-3">
                                            <input type="submit" name="" class="btn btn-success" style="font-size: 20px" value="Cập nhật trạng thái"/>
                                        </div>
                                    </div>
