            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="updateForm" action="StaffController" method="post" enctype="multipart/form-data" onsubmit="return validateResgisterCus();">
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <button name="btnUpdatefStaff" type="submit" style="background-color: #9d00ff;" class="btn">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="StaffController" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <button type="submit" style="background-color: #9d00ff;" class="btn" name="btnChangePassStaff">Change</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
