<%-- 
    ...
    Created on : Feb 21, 2024, 4:31:36 PM
    Author     : DELL
--%>
            ...
            <div class="col-lg-10 col-md-9 col-sm-9 min-vh-100 mt-3" style="position: absolute;
                ...
                <form method="" action="" class="border border-2 rounded-4 p-4 pt-2" style="margin: 0px 30px" onsubmit="return validateAddStaff()">
                    <div class="text-center mb-3">
                        <span class="h3 fw-bold">Câp nhât thông tin nhân viên</span>
                    </div>
                    ...
                    <div class="form-group w-100 mt-4">
                        <input type="text" id="nameStaff" name="nameStaff" placeholder="FullName" class="form-control form-control-lg" value="Vu Minh Uyen"/>
                    ...
                    <div class="form-group w-100 mt-4">
                        <input type="text" id="phoneStaff" name="phoneStaff" placeholder="Phone" class="form-control form-control-lg"value="0789 6165 73"/>
                    ...
                    <div class="form-group w-100 mt-4">
                        <input type="text" id="emailStaff" name="emailStaff" placeholder="Tiêu đề" class="form-control form-control-lg" value="ssss@gmail"/>
                        <label for="title" class="form-label">Email</label>
                        <span id="errorEmailStaff" class="errorEmailStaff text-danger fw-bold font-italic"></span>
                    </div>
                    <div class="form-group w-100 mt-4">
                        <input type="text" id="addressStaff" name="addressStaff" placeholder="Address" class="form-control form-control-lg"value="Kien Giang" />
                        <label for="title" class="form-label">Address</label>
                        <span id="errorAddressStaff" class="errorAddressStaff text-danger fw-bold font-italic"></span>
                    </div>
                    <div class="form-group w-100 mt-4">
                        <input type="text" id="positionStaff" name="positionStaff" placeholder="Position" class="form-control form-control-lg" value="ahihi"/>
                    ...
                    <div class="form-outline mt-4">
                        ...
                        <input type="date" id="dayWriteNews" name="dayWriteNews" class="form-control form-control-lg" value="10/10/2003" />
                    ...
                    <div class="form-outline mt-4">
                        ...
                        <input type="date" id="dayBegin" name="dayBegin" class="form-control form-control-lg" value="10/10/2003" />
                        <span id="errorDayBegin" class="text-danger fw-bold font-italic"></span>
                    </div>
                               <div class="form-outline mt-4">
                        <label class="form-label h5">End Work</label>
                        <input type="date" id="dayEnd" name="dayEnd" class="form-control form-control-lg" value="10/10/2003" />
                    ...
                    <div class="form-outline mb-3 mt-4">
                        <input type="submit" name="" class="btn btn-success w-100" style="font-size: 20px" value="Update Staff"/>
                    </div>  
                </form>
            </div>
        </div>
